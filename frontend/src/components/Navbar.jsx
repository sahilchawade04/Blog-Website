...
const Navbar = () => {
    ...
    const logoutHandler = async (e) => {
        ...
        try {
            ...
            console.log(error);
            // Even if backend fails (e.g. 401), we should clear local state
            navigate("/")
            dispatch(setUser(null))
    ...
    return (
        <div className='py-2 fixed w-full dark:bg-gray-800 dark:border-b-gray-600 border-b-gray-300 border-2 bg-white z-50 print:hidden'>
