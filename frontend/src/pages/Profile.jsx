...
const Profile = () => {
    ...
    const submitHandler = async (e) => {
        ...
        if (input.file && typeof input.file !== 'string') {
            formData.append("photoUrl", input.file)
        }
            ...
            <div className='max-w-6xl mx-auto mt-8 '>
                <Card className=" flex md:flex-row flex-col gap-10 p-6 md:p-10 dark:bg-gray-800 mx-4 md:mx-0">
                    ...
                    <div className='flex flex-col items-center justify-center md:w-[400px]'>
                        ...
                        <h1 className='text-center font-semibold text-xl text-gray-700 dark:text-gray-300 my-3'>{(user?.occupation && user?.occupation !== "null") ? user.occupation : "Full Stack Developer"}</h1>
